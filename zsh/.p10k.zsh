# Generated by Powerlevel10k configuration wizard on 2020-04-01 at 19:13 CEST.
...
# 24h time, angled separators, slanted heads, slanted tails, 1 line, compact,
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}落${VCS_STATUS_NUM_STAGED}"
